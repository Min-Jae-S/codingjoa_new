			...
			<div class="pt-3">
				<ul class="pagination justify-content-center">
					<c:if test="${pagination.prev}">
						<li class="page-item">
							<a class="page-link" href="${cri.getQuery}page=${pagination.prevPage}"><i class="fa-solid fa-chevron-left"></i></a>
						</li>
					</c:if>
					
					<c:forEach var="item" begin="${pagination.startPage}" end="${pagination.endPage}">
						<li class="page-item ${item eq pagination.page ? 'active' : ''}">
							<a class="page-link" href="${cri.getQuery}&page=${item}">${item}</a>
						</li>
					</c:forEach>
					
					<c:if test="${pagination.next}">
						<li class="page-item">
							<a class="page-link" href="${cri.getQuery}&page=${pagination.nextPage}"><i class="fa-solid fa-chevron-right"></i></a>
						</li>
					</c:if>
				</ul>
			</div>
