...
public class AdminUserDto {
	...
	@Builder
	private AdminUserDto(long id, String email, boolean hasPassword, String nickname, String zipcode, String addr,
	...
	public static AdminUserDto from(Map<String, Object> map) {
